...
/**
 * Cette classe représente une condition sur un état.
 */
public class ConditionEtat implements Condition, Serializable {
	 ...
	 * 
	 * @return true si l'état est actif, false dans le cas contraire.
	 */
	@Override
	 ...
	 * 
	 * @return false si l'état est actif, true dans le cas contraire.
	 */
	@Override
