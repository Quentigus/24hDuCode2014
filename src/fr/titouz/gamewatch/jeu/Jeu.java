...
/**
 * Cette classe repr�sente un game & watch.
 */
public class Jeu {
	...
	/**
	 * Ajoute un �couteur de tour de jeu.
	 * 
	 * @param l l'�couteur de tour de jeu.
	 */
	...
	/**
	 * Retire un �couteur de tour de jeu.
	 * 
	 * @param l l'�couteur � retirer.
	 */
	 ...
	 * 
	 * @return true si la condition de succ�s est remplie. Si pas de condition retourne false.
	 */
	...
	/**
	 * Test si le jeu est en �chec.
	 * 
	 * @return true si la condition d'�chec est remplie. Si pas de condition retourne false.
	 */
